...
#gui part
metro1.title("RAWATPUR TO MOTIJHEEL")
...
title=Label(text="--RAWATPUR TO MOTI JHEEL--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
