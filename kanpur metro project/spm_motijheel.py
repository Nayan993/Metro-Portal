...
#gui part
metro1.title("SPM HOSPITAL TO MOTIJHEEL")
...
title=Label(text="--SPM HOSPITAL TO MOTI JHEEL--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
...
#distance ans
title3=Label(text="7 KM",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
title3.place(x=330,y=190)
#time ans
title4=Label(text="00:12:43",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
title4.place(x=330,y=230)
#stations ans
title5=Label(text="6",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
