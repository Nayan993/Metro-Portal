...
#gui part
metro1.title("RAWATPUR TO IIT Kanpur")
...
title=Label(text="--RAWATPUR TO IIT KANPUR--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
