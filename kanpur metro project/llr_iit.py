...
#gui part
metro1.title("LLR HOSPITAL TO IIT Kanpur")
...
title=Label(text="--LLR HOSPITAL TO IIT Kanpur--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
...
#stations ans
title5=Label(text="7",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
