...
#gui part
metro1.title("MOTIJHEEL TO GURUDEV CHAURAHA")
...
title=Label(text="--MOTIJHEEL TO GURUDEV CHAURAHA--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
