...
#gui part
metro1.title("IIT TO Vishwavidalya")
...
title=Label(text="--IIT KANPUR TO Vishwavidalya--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
