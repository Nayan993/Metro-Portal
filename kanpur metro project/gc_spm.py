...
#gui part
metro1.title("GURUDEV CHAURAHA TO SPM HOSPITAL")
...
title=Label(text="--GURUDEV CHAURAHA TO SPM HOSPITAL--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
