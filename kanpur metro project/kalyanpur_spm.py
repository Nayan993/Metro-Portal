...
#gui part
metro1.title("KALYANPUR TO SPM HOSPITAL")
...
title=Label(text="--KALYANPUR TO SPM HOSPITAL--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
...
#first metro1 ans
title1=Label(text="06:02 AM",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
title1.place(x=330,y=110)
#last metro1 ans
title2=Label(text="10:02 PM",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
title2.place(x=330,y=150)
#distance ans
title3=Label(text="1 KM",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
title3.place(x=330,y=190)
#time ans
title4=Label(text="00:01:60",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
title4.place(x=330,y=230)
#stations ans
title5=Label(text="1",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
