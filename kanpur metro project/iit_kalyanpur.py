...
title=Label(text="--IIT KANPUR TO KALYANPUR--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
...
title10=Label(text="Store 99 etc.",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
...
Frame(metro1,width=110,height=2,bg="firebrick4").place(x=327,y=510)
