...
#gui part
metro1.title("SPM HOSPITAL TO Vishwavidalya")
...
title=Label(text="--SPM HOSPITAL TO VISHWAVIDALYA--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
