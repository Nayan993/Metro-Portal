...
#gui part
metro1.title("KLAYANPUR TO GURUDEV CHAURAHA")
...
title=Label(text="--KALYANPUR TO GURUDEV CHAURAHA--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
