...
#gui part
metro1.title("Vishwavidalya TO SPM HOSPITAL")
...
title=Label(text="--VISHWAVIDALYA To SPM HOSPITAL--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
...
#time ans
title4=Label(text="00:01:49",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
...
title10=Label(text="Shri Sai Store, V Mart etc.",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
...
Frame(metro1,width=220,height=2,bg="firebrick4").place(x=327,y=510)
