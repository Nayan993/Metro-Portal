...
#gui part
metro1.title("KALYANPUR TO LLR HOSPITAL")
...
title=Label(text="--KALYANPUR TO LLR HOSPITAL--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
