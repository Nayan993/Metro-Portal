...
#gui part
metro1.title("LLR HOSPITAL TO GURUDEV CHAURAHA")
...
title=Label(text="--LLR HOSPITAL TO GURUDEV CHAURAHA--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
...
#first metro1 ans
title1=Label(text="06:14 AM",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
title1.place(x=330,y=110)
#last metro1 ans
title2=Label(text="10:14 PM",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
title2.place(x=330,y=150)
#distance ans
title3=Label(text="3 KM",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
title3.place(x=330,y=190)
#time ans
title4=Label(text="00:05:27",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
title4.place(x=330,y=230)
#stations ans
title5=Label(text="3",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
...
title10=Label(text="Bhuvan Medical store, Banwari etc..",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
