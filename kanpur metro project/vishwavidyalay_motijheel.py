...
#gui part
metro1.title("Vishwavidalya TO Moti Jheel")
...
title=Label(text="--VISHWAVIDALYA TO MOTI JHEEL--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
