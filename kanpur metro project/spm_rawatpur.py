...
#gui part
metro1.title("SPM HOSPITAL TO RAWATPUR")
...
title=Label(text="--SPM HOSPITAL TO RAWATPUR--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
...
#time ans
title4=Label(text="00:09:50",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
