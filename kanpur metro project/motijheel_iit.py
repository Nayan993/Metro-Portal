...
#gui part
metro1.title("MOTIJHEEL TO IIT Kanpur")
...
title=Label(text="--MOTIJHEEL TO IIT KANPUR--",bg="thistle3",fg="firebrick4",font=myfont,padx=5,pady=6,borderwidth=5,relief=RIDGE)
...
#distance ans
title3=Label(text="8 KM",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
title3.place(x=330,y=190)
#time ans
title4=Label(text="00:14:32",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
title4.place(x=330,y=230)
#stations ans
title5=Label(text="8",bg="thistle1",fg="firebrick4",font=myfont1,padx=5,pady=6,borderwidth=0,relief=SUNKEN)
